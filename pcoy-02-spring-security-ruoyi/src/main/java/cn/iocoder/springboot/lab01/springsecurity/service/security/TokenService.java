...
import cn.iocoder.springboot.lab01.springsecurity.util.AddressUtils;
import cn.iocoder.springboot.lab01.springsecurity.util.IpUtils;
...
public class TokenService {
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            ...
            String uuid = (String) claims.get(AuthConstant.LOGIN_USER_KEY);
    ...
    public String createToken(LoginUser loginUser) {
        ...
        claims.put(AuthConstant.LOGIN_USER_KEY, token);
    ...
    private String getToken(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token) && token.startsWith(AuthConstant.TOKEN_PREFIX)) {
